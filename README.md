...
- Nyt projektin pitäisi latautua ongelmitta. Play-nappia painamalla ohjelman pitäisi käynnistyä. Editorin suhteen on huomioitava kuitenkin muutama seikka.

![alt text](ohjekuva-6.png)

- Ohjelman formatointi saattaa näyttää rikkinäiseltä, kun sille antaa käyttäjäsyötteen.

![alt text](ohjekuva-7.png)

- Asian saa korjattua vetämällä terminaalia ylöspäin heti sen jälkeen, kun on käynnistänyt ohjelman play-napista.

![alt text](ohjekuva-8.png)

- Sen jälkeen ohjelman ulosanti formatoituu, kuten pitää. Ohjelman käyttö onnistuu terminaaliin tulostuvaa opastusta seuraamalla. Muista painaa enter-näppäintä valitsemasi numeron/vaihtoehdon syöttämisen jälkeen.
